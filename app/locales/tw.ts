...
const tw = {
  ...
  Error: {
    Unauthorized: isApp
      ? `這個網站部署了 Xuc 自用的 AI 助手，需要密碼才能訪問。你現在有如下選擇：
    \\ 1️⃣ [前往 NextChat 官網使用](${SAAS_CHAT_UTM_URL})
    \\ 2️⃣ 前往[設置](/#/settings)填寫你自己的 API Key`
      : `這個網站部署了 Xuc 自用的 AI 助手，需要密碼才能訪問。你現在有如下選擇：
    \ 1️⃣ [前往 NextChat 官網使用](${SAAS_CHAT_UTM_URL})
    \ 2️⃣ 前往[登錄](/#/auth)填寫 Xuc 提供給你的密碼
    \ 3️⃣ 前往[設置](/#/settings)填寫你自己的 API Key
 `,
  },

  Auth: {
    Title: "需要密碼",
    Tips: "Xuc 開啟了密碼驗證，請在下方填入存取密碼",
    SubTips: "或者輸入你的 OpenAI 或 Google API 金鑰",
    Input: "在此處填寫存取密碼",
    Confirm: "確認",
    Later: "稍候再說",
    Return: "返回",
    SaasTips: "前往 NextChat 官網使用",
    TopTips: "",
  },
  ChatItem: {
  ...
  Store: {
    DefaultTopic: "新的對話",
    BotHello: "你好，我是 Xuc 的專屬 AI 助手。請問需要我的協助嗎？",
    Error: "出錯了，請稍後再嘗試",
    Prompt: {
